...
const ArticleCard = ({ article }) => (
  <div className="bg-gray-800 rounded-lg p-5 flex flex-col gap-3 border border-gray-700 hover:border-indigo-500 transition">
    <div className="flex items-start justify-between gap-2">
      <h3 className="text-white font-semibold text-base leading-snug line-clamp-2">{article.title}</h3>
      <a
        href={article.url}
        target="_blank"
