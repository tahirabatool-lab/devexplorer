...
const RepoCard = ({ repo }) => (
  <div className="bg-gray-800 rounded-lg p-5 flex flex-col gap-3 hover:bg-gray-750 border border-gray-700 hover:border-indigo-500 transition">
    <div className="flex items-start justify-between gap-2">
      <h3 className="text-white font-semibold text-base leading-snug">{repo.full_name}</h3>
      <a
        href={repo.html_url}
        target="_blank"
